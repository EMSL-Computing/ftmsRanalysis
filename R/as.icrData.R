...
.as.peakIcrData <- function(e_data, f_data, e_meta, edata_cname, fdata_cname, mass_cname,
                        ...
                        aroma_cname = NULL, modaroma_cname = NULL, dbe_cname = NULL, dbeo_cname = NULL,
                        elcomp_cname = NULL, class_cname = NULL, instrument_type = "12T"){
  ...
  attr(res, "cnames") = list(edata_cname = edata_cname, fdata_cname = fdata_cname, mass_cname = mass_cname, 
                             ...
                             dbeo_cname = dbeo_cname, elcomp_cname = elcomp_cname, class_cname = class_cname)
  
  attr(res, "instrument_type") = instrument_type
