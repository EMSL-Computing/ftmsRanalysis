...
Kendrick plots do something useful that I will have to find out about some other time. 

A Kendrick plot displays the Kendrick defect versus Kendrick mass for each peak observed. The `fticRanalysis` package 
